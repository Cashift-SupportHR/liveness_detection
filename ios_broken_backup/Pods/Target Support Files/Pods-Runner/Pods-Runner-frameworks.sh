...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/camerawesome/camerawesome.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_face_api/flutter_face_api.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/simple_native_image_compress/simple_native_image_compress.framework"
