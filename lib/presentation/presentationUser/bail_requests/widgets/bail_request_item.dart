...
class BailRequestItem extends BaseStatelessWidget {
  ...
  BailRequestItem({Key? key, required this.type, required this.request, required this.termsAndConditions, required this.onAccept, required this.onReject}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Container(
        ...
        margin: const EdgeInsetsDirectional.only(bottom: 14, start: 14, end: 14, top: 8),
        ...
        child: Column(
          ...
          children: [
            TitleIconServices(
              title: type == EmployeeServicesStatus.waitingForReview
              ...
              child: Column(
                ...
                children: [
                  ...
                  _CustomRichText(
                    ...
                    value: '${request.totalMoney?.toString() ?? ''}  ${strings.sar}',
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  _CustomRichText(
                    ...
                    value: '${request.totalInstallment?.toString() ?? ''}  ${strings.months}',
                  ),
...
class _CustomRichText extends StatelessWidget {
  ...
  const _CustomRichText({Key? key, required this.title1, required this.value, this.padding, this.valueColor})
      : super(key: key);
