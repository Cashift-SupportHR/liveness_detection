...
import 'progress_multi_touch_gesture_detector.dart';

class ProgressZoom extends StatefulWidget {
  ...
  _ProgressZoomState createState() => _ProgressZoomState();
}

class _ProgressZoomState extends State<ProgressZoom> with TickerProviderStateMixin {
  double localTop = 0.0;
